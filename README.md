...
```bash
# Git credentials
GIT_AUTHOR_NAME="Nguyen Khac Trieu"
GIT_COMMITTER_NAME="$GIT_AUTHOR_NAME"
git config --global user.name "$GIT_AUTHOR_NAME"
GIT_AUTHOR_EMAIL="trieunk@yahoo.com"
...
### [.datastores.sh](.datastores.sh) script
...
My contact info can be found on my [GitHub page](https://github.com/nobitagamer).
